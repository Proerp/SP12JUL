...
{
    public abstract class GenericViewDetailApiController<TEntity, TEntityDetail, TEntityViewDetail, TDto, TPrimitiveDto, TDtoDetail, TViewDetailViewModel> : GenericSimpleApiController<TEntity, TDto, TPrimitiveDto, TViewDetailViewModel>
        ...
        where TViewDetailViewModel : TDto, IViewDetailViewModel<TDtoDetail>, new()
    {
        ...
        public GenericViewDetailApiController(IGenericWithViewDetailService<TEntity, TEntityDetail, TEntityViewDetail, TDto, TPrimitiveDto, TDtoDetail> genericWithViewDetailService, IViewModelSelectListBuilder<TViewDetailViewModel> viewModelSelectListBuilder)
            : this(genericWithViewDetailService, viewModelSelectListBuilder, false, true)
        { }

        public GenericViewDetailApiController(IGenericWithViewDetailService<TEntity, TEntityDetail, TEntityViewDetail, TDto, TPrimitiveDto, TDtoDetail> genericWithViewDetailService, IViewModelSelectListBuilder<TViewDetailViewModel> viewModelSelectListBuilder, bool isCreateWizard)
            : this(genericWithViewDetailService, viewModelSelectListBuilder, isCreateWizard, false)
        { }

        public GenericViewDetailApiController(IGenericWithViewDetailService<TEntity, TEntityDetail, TEntityViewDetail, TDto, TPrimitiveDto, TDtoDetail> genericWithViewDetailService, IViewModelSelectListBuilder<TViewDetailViewModel> viewModelSelectListBuilder, bool isCreateWizard, bool isSimpleCreate)
